...
const OrderInvoice = ({ onPlaceOrder }) => {
    ...
    const handleSearchChange = (e) => {
        const value = e.target.value.toLowerCase(); // lowercase once
        setSearchTerm(value);
        ...
        if (!value.trim()) {
            ...
            const filtered = items.filter((item) =>
                item.I_Id.toString().toLowerCase().includes(value) || // make ID search case-insensitive
    ...
    const handleSubmit = async (e) => {
       ...
       const updatedFormData = {
        ...
        const totalBillPrice = totalItemPrice + parseFloat(deliveryPrice || 0) - parseFloat(discountAmount || 0);
